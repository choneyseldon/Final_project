  ...
  Future<List<Post>> getAllPosts() async {
    try {
      if (kIsWeb) {
        ...
        if (postsJson != null && postsJson.isNotEmpty && postsJson != 'null') {
          try {
  ...
  Future<void> savePost(Post post) async {
    try {
      ...
      if (kIsWeb) {
        ...
        final postsData = existingPosts.map((p) => p.toJson()).toList();
        final postsJson = json.encode(postsData);
        if (postsJson.isNotEmpty && postsJson != 'null') {
